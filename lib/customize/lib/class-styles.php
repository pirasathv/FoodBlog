<?php
/**
 * A helper class for generating CSS based on user input.
 *
 ...
 */
class Feastco_Customizer_Styles {

	/**
	 * The one instance of Feastco_Customizer_Styles.
	 *
	 * @since 1.0.0.
	 *
	 * @var   Feastco_Customizer_Styles    The one instance for the singleton.
	 */
	...
	/**
	 * Instantiate or return the one Feastco_Customizer_Styles instance.
	 *
	 * @since  1.0.0.
	 *
	 * @return Feastco_Customizer_Styles
	 */
	 ...
	 *
	 * Feastco_Customizer_Styles()->add( array(
	...
	private function parse_declarations( $declarations, $tab = '' ) {
		 ...
		 * routines are implemented when the developer calls `Feastco_Customizer_Styles()->add`. Because every property value has
